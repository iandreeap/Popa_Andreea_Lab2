...
namespace Popa_Andreea_Lab2.Data
{
    public class Popa_Andreea_Lab2Context : DbContext
    {
        ...
        public DbSet<Popa_Andreea_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Popa_Andreea_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Popa_Andreea_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
